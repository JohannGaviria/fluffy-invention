...
| Mongo Configuration        | MONGO_URL                    | MongoDB connection URL                                                   | mongodb://mongo:password@fluffy-invention-mongodb:27017/fluffy_invention_mongo?authSource=admin |
| Mongo Configuration        | MONGO_PORT                   | Port where the MongoDB service is exposed                                | 27017                                                                                           |
| Mongo Configuration        | MONGO_DB                     | Name of the MongoDB database                                             | fluffy_invention_mongo                                                                          |
| Mongo Configuration        | MONGO_USER                   | Username used to authenticate with the MongoDB database                  | mongo                                                                                           |
| Mongo Configuration        | MONGO_PASSWORD               | Password used to authenticate with the MongoDB database                  | password                                                                                        |
